...
class Admin {
	...
	public function columnFilters() {
		...
		$can_login_label = (in_array($can_login, ['', '-1'])) ? __('Login status', 'user-toolkit') : __('All', 'user-toolkit');
		?>
        <div class="alignleft actions">
            <form method="get">
                <label class="screen-reader-text" for="can_login"><?php esc_html_e('All login status', 'user-toolkit') ?></label>
                ...
                <label class="screen-reader-text" for="can_login"><?php esc_html_e('Login date range', 'user-toolkit') ?></label>
